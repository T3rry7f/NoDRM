...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 11817136,
    DYNAMIC_BASE = 17060016,
    DYNAMICTOP_PTR = 11816976;
...
var INITIAL_TOTAL_MEMORY = Module['TOTAL_MEMORY'] || 18743296;if (!Object.getOwnPropertyDescriptor(Module, 'TOTAL_MEMORY')) Object.defineProperty(Module, 'TOTAL_MEMORY', { configurable: true, get: function() { abort('Module.TOTAL_MEMORY has been replaced with plain INITIAL_TOTAL_MEMORY') } });
...
var wasmBinaryFile = 'wasm_gsr.wasm';
...
// STATICTOP = STATIC_BASE + 11816112;
...
var real__freeStr = asm["freeStr"];
asm["freeStr"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__freeStr.apply(null, arguments);
};

var real__tryUsingDecoder = asm["tryUsingDecoder"];
asm["tryUsingDecoder"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__tryUsingDecoder.apply(null, arguments);
};
...
var _freeStr = Module["_freeStr"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["freeStr"].apply(null, arguments)
};

var _tryUsingDecoder = Module["_tryUsingDecoder"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["tryUsingDecoder"].apply(null, arguments)
};
