...
class WidevineCDM:
    ...
    def SetServerCertificate(self):
        data=b'\x08\x04'
        cert=requests.post(self.license_url,data).content
    ...
    def GetContentKey(self,lic_request_data):
        ...
        license_request_msg.ParseFromString(requestMessage.msg)
        #print license_request_msg

        requestMessage.msg=license_request_msg.SerializeToString()
        ...
        enc_session_key=binascii.b2a_hex(responseMessage.session_key)
        self.sock.send(enc_session_key)#
        sessionKey=binascii.a2b_hex(self.sock.recv(1024))  
